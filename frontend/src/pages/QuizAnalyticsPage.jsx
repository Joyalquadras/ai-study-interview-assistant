...
const StatSkeleton = () => (
  <div className="animate-pulse rounded-xl bg-gray-200 dark:bg-gray-700 h-24 sm:h-28" />
);
...
const CustomTooltip = ({ active, payload }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-2 shadow-lg text-xs sm:text-sm">
    ...
    <div className="max-w-5xl mx-auto">
      ...
      {loading && (
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="animate-pulse rounded-xl bg-gray-200 dark:bg-gray-700 h-56 sm:h-80" />
        </div>
      )}
      ...
      {!loading && !isEmpty && analytics && (
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-3 sm:p-5 text-center">
            ...
            <div className="rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 p-3 sm:p-5 text-center">
            ...
            <div className="rounded-xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-3 sm:p-5 text-center">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4 sm:p-6 mb-6 sm:mb-8">
            ...
            <div className="h-52 sm:h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 8, right: 4, left: -16, bottom: 8 }}>
                  <XAxis
                    dataKey="label"
                  ...
                  <Bar dataKey="percentage" radius={[6, 6, 0, 0]}>
                    {chartData.map((entry) => (
                      <Cell key={entry.confidence} fill={getBarColor(entry.percentage)} />
                    ))}
                  </Bar>
                </BarChart>
              </ResponsiveContainer>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="rounded-xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base text-red-800 dark:text-red-200 mb-2">
            ...
            <div className="rounded-xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-900/20 p-4 sm:p-6">
              <h3 className="font-bold text-sm sm:text-base text-green-800 dark:text-green-200 mb-2">
