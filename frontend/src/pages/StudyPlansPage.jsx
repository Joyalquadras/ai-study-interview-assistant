  ...
  <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-5 shadow-sm">
    ...
    <ul className="space-y-4">
      {(day.tasks || []).map((task, taskIdx) => (
        <li
          key={taskIdx}
          className="border-t border-gray-100 dark:border-gray-800 pt-4 first:border-t-0 first:pt-0"
        >
...
export const StudyPlansPage = () => {
  ...
  const handleGenerate = async (e) => {
    ...
    if (!targetDate) {
      showToast.error('Please select a target date');
      return;
    }
    ...
    try {
      ...
      const res = await studyPlanAPI.generatePlan({
        goal: goal.trim(),
        topics,
        hoursPerDay,
        targetDate,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-8">
            <form
              ...
              className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm space-y-5"
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50"
                />
              </div>
              ...
              <div>
                ...
                >
                  {topics.map((topic) => (
                    <span
                      key={topic}
                      className="inline-flex items-center gap-1 px-2.5 py-1 text-sm rounded-full bg-indigo-100 text-indigo-800 dark:bg-indigo-900/50 dark:text-indigo-200"
                    >
                      {topic}
                      <button
                        type="button"
                  ...
                  <input
                    ...
                    placeholder={topics.length === 0 ? 'Type a topic, press Enter or comma' : ''}
                    disabled={isGenerating}
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="w-10 h-10 rounded-lg border border-gray-300 dark:border-gray-600 text-lg font-medium hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-40"
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (!Number.isNaN(v)) {
                        setHoursPerDay(Math.min(MAX_HOURS, Math.max(MIN_HOURS, v)));
                      }
                    }}
                    disabled={isGenerating}
                    className="w-16 text-center px-2 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  />
                  <button
                    type="button"
                    onClick={() => adjustHours(1)}
              ...
              <button
                type="submit"
                disabled={isGenerating}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                {isGenerating ? (
                  <>
                  ...
                  {previousPlans.map((plan) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex-shrink-0 px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 border border-blue-600 dark:border-blue-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 disabled:opacity-50"
                      >
                        View
                      </button>
                    </li>
          ...
          <div className="lg:sticky lg:top-8">
            <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-6 min-h-[400px]">
