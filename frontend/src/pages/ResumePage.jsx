      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {analysis && (
          <div className="space-y-8">
            ...
            {/* ATS Score */}
            <section className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl p-6 flex flex-col sm:flex-row items-center gap-6">
              <CircularProgress
                value={atsScore}
                progress={atsScore}
                size={140}
              ...
              <section>
                ...
                <div className="flex flex-wrap gap-2">
                  {analysis.missingKeywords.map((keyword, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 text-sm rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-300"
                    >
                      {keyword}
                    </span>
                  ))}
              ...
              <section>
                ...
                <ol className="space-y-3 list-none">
                  {analysis.improvementSuggestions.map((suggestion, idx) => (
                    <li
                      key={idx}
                      className="flex gap-3 p-4 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-900"
                    >
            ...
            {analysis.overallFeedback && (
              <section>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
                  {analysis.overallFeedback}
                </p>
              </section>
            )}
